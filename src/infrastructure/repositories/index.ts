...
export default class OrdersRepository implements IOrdersRepository {
    ...
    findOrderById(id: string, options: FindOrdersOptions = { withItems: true, withShippingAddress: true }): Promise<Order | null> {
    ...
    deleteOrders(params: Prisma.OrderDeleteManyArgs): Promise<Prisma.BatchPayload> {
