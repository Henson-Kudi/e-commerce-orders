...
export default class GetOrderUseCase implements IUseCase<{ id: string, options: FindOrdersOptions }, Promise<IReturnValue<Order>>> {
    private orderRepository: IOrdersRepository;
    constructor(orderRepository: IOrdersRepository) {
        this.orderRepository = orderRepository;
    }
    async execute(params: { id: string, options: FindOrdersOptions }): Promise<IReturnValue<Order>> {
